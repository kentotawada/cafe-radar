...
const dictionary = {
  ja: {
    ...
    "gmap.outletSeatCountLabel": "電源席数",
    "gmap.noteLabel": "電源席の場所など",
    "gmap.notePlaceholder": "例: 窓際のカウンターのみ",
    "gmap.correctionLabel": "載っている情報が違う",
    "gmap.correctionPlaceholder": "例: 閉店していた / 席がなかった",
    "gmap.correctionThanks": "ありがとうございます。確認します",
  },
  en: {
    ...
    "gmap.outletSeatCountLabel": "Outlet seats",
    "gmap.noteLabel": "Where the outlets are",
    "gmap.notePlaceholder": "e.g. only the window counter",
    "gmap.correctionLabel": "The listed info is wrong",
    "gmap.correctionPlaceholder": "e.g. closed down / no seating",
    "gmap.correctionThanks": "Thanks. We'll check it.",
  },
} as const;
