...
export const cafes: Cafe[] = [
  { id: "hamamatsucho-01", name: "マクドナルド 大門店", address: "東京都港区芝大門2-3-1 常泉ビル", lat: 35.6567091, lng: 139.7538821, smokingInfo: "全店舗禁煙方針、喫煙ルームなし(2014年8月より全店舗全席禁煙)", wifiInfo: "無料Wi-Fiあり(00_MCD-FREE-WIFI、全店舗共通サービス)", seatCountInfo: "62席", hoursInfo: "24時間営業(0:00〜5:00はテイクアウトのみ)", closedDaysInfo: "年中無休" },
  ...
  { id: "hamamatsucho-05", name: "スターバックス コーヒー ブルーフロント芝浦店", address: "東京都港区芝浦1-1-1 BLUE FRONT SHIBAURA 3F", lat: 35.6509238, lng: 139.757357, smokingInfo: "全店舗禁煙方針、喫煙所なし", wifiInfo: "無料Wi-Fiあり(at_STARBUCKS_Wi2、登録不要で利用規約に同意するだけ)", hoursInfo: "月〜金7:00〜21:00、土8:00〜18:00", closedDaysInfo: "日・祝" },
  ...
  { id: "hamamatsucho-29", name: "タリーズコーヒー 芝公園店", address: "東京都港区芝公園2-4-1 芝パークビル1F", lat: 35.65600656, lng: 139.75223008, smokingInfo: "全席禁煙", hoursInfo: "平日7:30〜18:00、土9:00〜17:00", closedDaysInfo: "日曜日" },
  ...
  { id: "hamamatsucho-31", name: "エクセルシオール カフェ バリスタ 東京汐留ビルディング店", address: "東京都港区東新橋1-9-1 東京汐留ビルディング2F202", lat: 35.66293932, lng: 139.76121207, hoursInfo: "月火水木金7:00〜19:00、土日祝8:00〜18:00" },
