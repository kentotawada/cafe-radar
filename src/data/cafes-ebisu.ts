...
export const cafes: Cafe[] = [
  ...
  { id: "ebisu-02", name: "スターバックス コーヒー 恵比寿ガーデンプレイスタワー１Ｆ店", address: "東京都渋谷区恵比寿4-20-3 恵比寿ガーデンプレイスタワー", lat: 35.643627, lng: 139.712708, outletInfo: "窓際カウンター12席中6席に電源あり", smokingInfo: "全席禁煙", wifiInfo: "無料Wi-Fiあり(at_STARBUCKS_Wi2、docomo)", seatCountInfo: "48席", hoursInfo: "平日7:00〜22:00、土日祝8:00〜22:00", closedDaysInfo: "不定休" },
  ...
  { id: "ebisu-11", name: "エクセルシオール カフェ 恵比寿ガーデンプレイス店", address: "東京都渋谷区恵比寿4-20-3 恵比寿ガーデンプレイスタワー1F", lat: 35.643627, lng: 139.712708, outletInfo: "コンセント席が多く打ち合わせ利用も" },
  ...
  { id: "ebisu-23", name: "カフェ・ド・クリエ グラン 恵比寿ガーデンプレイス店", address: "東京都渋谷区恵比寿4-20-3 恵比寿ガーデンプレイスタワー1F", lat: 35.643627, lng: 139.712708, outletInfo: "コンセント付きカウンター多数", smokingInfo: "分煙(喫煙ブースあり)", wifiInfo: "無料Wi-Fiあり", hoursInfo: "月〜木7:00〜21:00、金〜日8:00〜21:00" },
