...
export const cafes: Cafe[] = [
  ...
  { id: "kichijoji-10", name: "スターバックス コーヒー 吉祥寺東急店", address: "東京都武蔵野市吉祥寺本町2-3-1 東急百貨店吉祥寺店1F", lat: 35.7049908, lng: 139.5778647, outletInfo: "窓側カウンター手前4席のみ電源コンセントあり", wifiInfo: "無料Wi-Fiあり(STARBUCKS/docomo/Softbank/Wi2 300等複数ネットワーク対応)", hoursInfo: "8:00〜22:00", closedDaysInfo: "不定休(東急百貨店吉祥寺店に準ずる)" },
