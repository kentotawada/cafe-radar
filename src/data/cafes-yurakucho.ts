...
export const cafes: Cafe[] = [
  ...
  { id: "yurakucho-03", name: "マクドナルド 銀座二丁目ビル店", address: "東京都中央区銀座2-9-4", lat: 35.672428910954, lng: 139.76814923677, outletInfo: "2階席にコンセントあり、長居作業も可" },
  ...
  { id: "yurakucho-08", name: "スターバックス コーヒー JR有楽町駅京橋口店", address: "東京都千代田区有楽町2-9", lat: 35.6751241, lng: 139.7637501, outletInfo: "2階に電源コンセント席8席あり", smokingInfo: "全店舗禁煙方針、喫煙所なし", wifiInfo: "無料Wi-Fiあり(at_STARBUCKS_Wi2、登録不要で利用規約に同意するだけ)", hoursInfo: "7:00〜22:00", closedDaysInfo: "不定休" },
  ...
  { id: "yurakucho-70", name: "スターバックス コーヒー 東京ミッドタウン日比谷店", address: "東京都千代田区有楽町1-1-4 東京ミッドタウン日比谷", lat: 35.6736991, lng: 139.7592588, smokingInfo: "全店舗禁煙方針、喫煙所なし", wifiInfo: "無料Wi-Fiあり(at_STARBUCKS_Wi2、登録不要で利用規約に同意するだけ)", hoursInfo: "7:00〜22:30", closedDaysInfo: "不定休" },
  ...
  { id: "yurakucho-81", name: "プロント ライブラリーショップ＆カフェ日比谷", address: "東京都千代田区日比谷公園1-4 日比谷図書文化館 1F", lat: 35.6718492, lng: 139.7545371, smokingInfo: "全席禁煙", seatCountInfo: "150席", hoursInfo: "平日10:00〜19:00、土日祝10:00〜17:00", closedDaysInfo: "不定休(日比谷図書文化館の営業に準ずる)" },
